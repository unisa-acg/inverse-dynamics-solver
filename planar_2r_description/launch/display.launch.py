...
def launch_setup(context: LaunchContext, *args, **kwargs):
    ...
    # Robot description
    package_path = FindPackageShare("planar_2r_description")
    xacro_file = PathJoinSubstitution([package_path, "urdf", "planar_2r.urdf.xacro"])
    robot_description = Command(["xacro ", xacro_file, f" a1:={a1} a2:={a2}"])
...
def generate_launch_description():
    ...
    return LaunchDescription([a1, a2] + [OpaqueFunction(function=launch_setup)])
