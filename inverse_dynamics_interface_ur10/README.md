...
The library [InverseDynamicsSolverUR10](./include/inverse_dynamics_interface_ur10/inverse_dynamics_interface_ur10.hpp) depends on the following files, automatically generated with MATLAB:
...
You can evaluate the solver using the [demo](../inverse_dynamics_solver/demo/evaluate_solver.cpp), whose configuration for the UR10 robot is provided though a [launch file](./launch/evaluate_dynamics.launch.py).
...
build/inverse_dynamics_interface_ur10/test_results/inverse_dynamics_interface_ur10/launch_test_ur10_inverse_dynamics_solver.launch.py.xunit.xml: 2 tests, 0 errors, 0 failures, 0 skipped
