 ...
 *
 * Title:   inverse_dynamics_interface_ur10.cpp
...
#include "inverse_dynamics_interface_ur10/getCurrents.hpp"
#include "inverse_dynamics_interface_ur10/inverse_dynamics_interface_ur10.hpp"

namespace inverse_dynamics_interface_ur10

{
void InverseDynamicsInterfaceUR10::initialize(rclcpp::node_interfaces::NodeParametersInterface::ConstSharedPtr, const std::string&,
                                              const std::string&)
{
...
Eigen::MatrixXd InverseDynamicsInterfaceUR10::getInertiaMatrix(const Eigen::VectorXd& joint_positions) const
{
...
Eigen::VectorXd InverseDynamicsInterfaceUR10::getCoriolisVector(const Eigen::VectorXd& joint_positions, const Eigen::VectorXd& joint_velocities) const
{
  Vector6d::Map(q_) = joint_positions;
...
Eigen::VectorXd InverseDynamicsInterfaceUR10::getGravityVector(const Eigen::VectorXd& joint_positions) const
{
  Vector6d::Map(q_) = joint_positions;
...
Eigen::VectorXd InverseDynamicsInterfaceUR10::getFrictionVector(const Eigen::VectorXd& joint_velocities) const
{
...
Vector6d InverseDynamicsInterfaceUR10::getFrictionCurrents_(const Vector6d& joint_velocities) const
{
...
Matrix6d InverseDynamicsInterfaceUR10::getDriveGainsMatrix_() const
{
...
PLUGINLIB_EXPORT_CLASS(inverse_dynamics_interface_ur10::InverseDynamicsInterfaceUR10, inverse_dynamics_interface::InverseDynamicsInterface)
