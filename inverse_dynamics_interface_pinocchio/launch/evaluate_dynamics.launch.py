...
def launch_setup(_: LaunchContext, *args, **kwargs):
    ...
    input_bag = PathJoinSubstitution(
        [
            FindPackageShare("inverse_dynamics_interface_pinocchio"),
            "bagfiles",
            input_bag,
        ]
    )
    ...
    return [
        IncludeLaunchDescription(
            PythonLaunchDescriptionSource(
                PathJoinSubstitution(
                    [
                        FindPackageShare("inverse_dynamics_interface"),
                        "launch",
                        "evaluate_dynamics.launch.py",
                    ]
                )
            ),
            launch_arguments={
                ...
                "topic": topic,
                "plugin_name": "inverse_dynamics_interface_pinocchio/InverseDynamicsInterfacePinocchio",
...
def generate_launch_description():
    ...
    output_bag = DeclareLaunchArgument(
        "output_bag",
        default_value="ur10_exciting_trajectory_torques_pinocchio",
